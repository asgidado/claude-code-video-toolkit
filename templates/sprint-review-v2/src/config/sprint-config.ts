...
// TransitionSeries overlaps reduce total duration by the sum of transition frames:
//   Title→Overview fade(25) + Overview→Demo slide(20) + Demo→Summary lightLeak(35) + Summary→Credits fade(30)
//   + Demo→Demo slide(15) per inter-demo transition
// With 0 demos: 25 + 35 + 30 = 90 frames = 3s overlap
// Adjust durationSeconds to account for this overlap (raw scene sum minus overlaps).
export const videoConfig: VideoConfig = {
  fps: 30,
  width: 1920,
  height: 1080,
  durationSeconds: 120, // Adjust based on your content (account for ~3s transition overlap)
};
